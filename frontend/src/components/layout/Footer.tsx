      ...
      <div className="footer__inner container">
        ...
        <div className="footer__col footer__col--brand">
          ...
          <p className="footer__desc">
            {footerText || 'Thời trang trẻ trung, phong cách hiện đại. Tạo nên sự tự tin cho bạn mỗi ngày.'}
          </p>
        ...
        <div className="footer__col footer__col--newsletter">
          <h4 className="footer__col-title">Đăng ký nhận tin</h4>
          <p className="footer__desc">Nhận thông tin ưu đãi & bộ sưu tập mới nhất.</p>
          <form className="footer__subscribe" onSubmit={(e) => e.preventDefault()}>
            <input type="email" placeholder="Email của bạn" className="footer__subscribe-input" />
            <button type="submit" className="btn-accent footer__subscribe-btn">→</button>
          </form>
        </div>
      </div>
